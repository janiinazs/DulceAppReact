    ...
    <SafeAreaView style={styles.screen}>
      ...
      >
        <View style={styles.card} accessibilityRole="form">
          ...
          <Text style={styles.subtitle}>¡Hola! Entra y{`\n`}descubre en mundo de sabor</Text>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Register')} style={styles.registerRow} accessibilityRole="link">
